...
public class Llingkaran extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_llingkaran);
        ImageView txPopup6=findViewById(R.id.backback);
        txPopup6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                PopupMenu ppMenu = new PopupMenu(Llingkaran.this, v);
                ppMenu.setOnMenuItemClickListener(Llingkaran.this);
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        ...
                        switch(id) {
                            case R.id.logout:
                                ...
                                Intent intent = new Intent(Llingkaran.this, MainActivity.class);
                                Llingkaran.this.startActivity(intent);
                                finish();
                            default:
                                return true;
                        }
