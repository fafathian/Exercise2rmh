...
public class ktrapesium extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ktrapesium);
        ImageView txPopup6=findViewById(R.id.backback);
        txPopup6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                PopupMenu ppMenu = new PopupMenu(ktrapesium.this, v);
                ppMenu.setOnMenuItemClickListener(ktrapesium.this);
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        ...
                        switch(id) {
                            case R.id.logout:
                                ...
                                Intent intent = new Intent(ktrapesium.this, MainActivity.class);
                                ktrapesium.this.startActivity(intent);
                                finish();
                            default:
                                return true;
                        }
