...
public class Lsegitiga extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txPopup6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                PopupMenu ppMenu = new PopupMenu(Lsegitiga.this, v);
                ppMenu.setOnMenuItemClickListener(Lsegitiga.this);
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        ...
                        switch(id) {
                            case R.id.logout:
                                ...
                                Intent intent = new Intent(Lsegitiga.this, MainActivity.class);
                                Lsegitiga.this.startActivity(intent);
                                finish();
                            default:
                                return true;
                        }
