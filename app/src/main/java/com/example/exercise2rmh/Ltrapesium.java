...
public class Ltrapesium extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ltrapesium);

        ImageView txPopup6=findViewById(R.id.backback);
        txPopup6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                PopupMenu ppMenu = new PopupMenu(Ltrapesium.this, v);
                ppMenu.setOnMenuItemClickListener(Ltrapesium.this);
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        ...
                        switch(id) {
                            case R.id.logout:
                                ...
                                Intent intent = new Intent(Ltrapesium.this, MainActivity.class);
                                Ltrapesium.this.startActivity(intent);
                                finish();
                            default:
                                return true;
                        }
